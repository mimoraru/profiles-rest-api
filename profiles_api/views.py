...
class HelloApiView(APIView):
    ...
    def get(self, request, format=None):
        ...
        an_apiview = [
            ...
            'Is similar to a traditional Djang View',
    ...
    def patch (self, request, pk=None):
        """Handle a partial update fo an object"""
...
class UserProfileFeedViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = (
        permissions.UpdateOwnStatus, IsAuthenticated) #to restrict users seeing statuses without them beint authenticated
